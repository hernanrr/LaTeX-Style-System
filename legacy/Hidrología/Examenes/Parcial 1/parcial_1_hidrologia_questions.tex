...
\question [3] Cuando se dice que un país puede tener agua en promedio anual pero seguir sufriendo escasez, se está enfatizando principalmente:
\begin{choices}
...
\question [3] ¿Cuál de los siguientes problemas es típicamente hidrológico y no solo administrativo?
\begin{choices}
...
\question [3] En la República Dominicana, una lectura básica del problema del agua debe incluir:
\begin{choices}
...
\question [3] El Plan Hidrológico Nacional 2025-2045 presenta como idea general:
\begin{choices}
...
\question [2] ¿Qué capítulo del Plan Hidrológico Nacional trata el marco físico y climatológico?
\begin{choices}
\choice Capítulo 1.
...
\question [2] ¿Qué capítulo del Plan Hidrológico Nacional trata la caracterización del ámbito del estudio?
\begin{choices}
\choice Capítulo 2.
\choice Capítulo 4.
...
\question [2] ¿Qué capítulo del Plan Hidrológico Nacional desarrolla recursos hídricos, demandas y balances?
\begin{choices}
\choice Capítulo 1.
\choice Capítulo 3.
\choice Capítulo 5.
...
\question [3] Según la lectura general del PHN, una prioridad operativa coherente con el documento es:
\begin{choices}
...
\question [2] La diferencia principal entre tiempo atmosférico y clima es que:
\begin{choices}
...
\question [2] ¿Cuál variable meteorológica está más directamente asociada con la energía disponible para evaporación?
\begin{choices}
...
\question [2] En una estación meteorológica, el instrumento asociado más directamente con la velocidad del viento es:
\begin{choices}
\choice pluviómetro.
\choice barómetro.
...
\question [2] Un aumento de temperatura, manteniendo lo demás constante, tiende a:
\begin{choices}
...
\question [3] Si se desea estudiar el impacto de un cambio climático sobre recursos hídricos, una variable básica a revisar es:
\begin{choices}
...
\question [3] Una relación útil entre meteorología e hidrología en el curso es:
\begin{choices}
...
\question [3] La importancia de la cuenca como unidad de análisis hidrológico radica en que:
\begin{choices}
...
\question [3] Entre los rasgos fisiográficos que influyen en la respuesta de la cuenca está:
\begin{choices}
\choice la forma, el relieve y la red de drenaje.
\choice solo el color del suelo.
\choice la edad del ingeniero.
\choice el formato del informe.
\end{choices}

\question [3] En términos morfométricos, la respuesta hidrológica de una cuenca está controlada principalmente por:
\begin{choices}
...
\question [3] Si una cuenca tiene 36 km de cauces y 12 km\textsuperscript{2} de área, su densidad de drenaje es:
\begin{choices}
\choice 0.33 km/km\textsuperscript{2}.
\choice 2 km/km\textsuperscript{2}.
\CorrectChoice 3 km/km\textsuperscript{2}.
\choice 4 km/km\textsuperscript{2}.
\end{choices}

\question [3] Una cuenca alargada, en comparación con una compacta y con lluvia similar, tiende a producir:
\begin{choices}
...
\question [3] Una cuenca con área de 50 km\textsuperscript{2} y longitud principal de 10 km tiene un factor de forma aproximado de:
\begin{choices}
\choice 0.05.
\choice 0.2.
\CorrectChoice 0.5.
...
\question [3] ¿Cuál opción diferencia mejor escurrimiento superficial y subsuperficial?
\begin{choices}
...
\question [3] ¿Qué efecto suele tener la urbanización sobre la respuesta hidrológica de una cuenca?
\begin{choices}
...
\question [3] La principal diferencia entre cuenca superficial y cuenca subterránea es que:
\begin{choices}
...
\question [8] Explique en 4 a 6 líneas cómo la forma de la cuenca y su red de drenaje influyen en el tiempo al pico y en el gasto pico del hidrograma.
